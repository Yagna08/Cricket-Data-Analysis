...
import pandas as pd
with open('T20 Scraping\T20ScoreCardList.txt','r',encoding='utf-8', errors='ignore') as f:
    links = f.readlines()
...
for link in links:
    file = open('T20 Scraping\T20ScoreCard\\'+link.split('/')[-2]+'.html','r',encoding='utf-8', errors='ignore')
